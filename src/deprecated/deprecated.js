...
export default {
	stylistic: [
		{
			...
			value: ['off', 'consistent'],
			config: 'style',
			replacedIn: 'stylistic',
			replacedBy: [],
		...
		},
		{
			...
			value: ['off', { multiline: true, minItems: 3 }],
			config: 'style',
			replacedIn: 'stylistic',
			replacedBy: [],
		...
		},
		{
			...
			value: ['error', 'multiline-arguments'],
			config: 'style',
			replacedIn: 'stylistic',
			replacedBy: [],
		...
		{
			name: 'key-spacing',
			value: ['error', { beforeColon: false, afterColon: true }],
			config: 'style',
			replacedIn: 'stylistic',
			replacedBy: [],
		...
		},
		{
			...
			value: ['error', 'always', { exceptAfterSingleLine: false }],
			config: 'style',
			replacedIn: 'stylistic',
			replacedBy: [],
		...
		},
		{
			...
			value: ['error', { ignoreChainWithDepth: 4 }],
			config: 'style',
			replacedIn: 'stylistic',
			replacedBy: [],
		...
		},
		{
			...
			value: ['error', { ignoreEOLComments: false }],
			config: 'best-practices',
			replacedIn: 'stylistic',
			replacedBy: [],
		...
		},
		{
			...
			value: ['error', { max: 1, maxBOF: 0, maxEOF: 0 }],
			config: 'style',
			replacedIn: 'stylistic',
			replacedBy: [],
		...
		},
		{
			...
			value: ['error', { skipBlankLines: false, ignoreComments: false }],
			config: 'style',
			replacedIn: 'stylistic',
			replacedBy: [],
		...
		},
		{
			...
			value: ['error', { allowAllPropertiesOnSameLine: true }],
			config: 'style',
			replacedIn: 'stylistic',
			replacedBy: [],
		...
		},
		{
			...
			value: ['error', 'before', { overrides: { '=': 'none' } }],
			config: 'style',
			replacedIn: 'stylistic',
			replacedBy: [],
		...
		},
		{
			...
			value: ['error', { words: true, nonwords: false, overrides: {} }],
			config: 'style',
			replacedIn: 'stylistic',
			replacedBy: [],
		...
		{
			name: 'wrap-iife',
			value: ['error', 'outside', { functionPrototypeMethods: false }],
			config: 'best-practices',
			replacedIn: 'stylistic',
			replacedBy: [],
	...
	missing: [
		...
		},
		{
			...
			value: ['error', { before: 'always', after: 'always' }],
			config: 'style',
			replacedIn: null,
